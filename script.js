...
headImg.src = 'head.png'; // Assuming head.png is in the root directory

const bodyImg = new Image();
bodyImg.src = 'body.png'; // Assuming body.png is in the root directory

const tailImg = new Image();
tailImg.src = 'tail.png'; // Assuming tail.png is in the root directory

const foodImg = new Image();
foodImg.src = 'food.png'; // Assuming food.png is in the root directory

const bigFoodImg = new Image();
bigFoodImg.src = 'ball.png'; // Using ball.png for big food

// Load audio files
const foodAteAudio = new Audio('food ate.mp3');
const bigFoodAppearanceAudio = new Audio('bigfood appearance.mp3');
const bigFoodAteAudio = new Audio('bigfood appearance ate.mp3');
